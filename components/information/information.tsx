        ...
        <>
            {
                props.selectEvent ?
                    <div className={`${styles['info-container']} relative bg-gray-50 p-10 pb-20 px-4 sm:px-6 lg:pb-10 lg:px-8`}>
                        ...
                        <div className="relative max-w-7xl mx-auto overflow-x-scroll md:overflow-y-hidden md:overflow-x-auto">
                            ...
                            <div className={styles['event-card-container'] + " mt-12 xl:max-w-lg mx-auto grid gap-5 lg:grid-cols lg:max-w-none"}>
